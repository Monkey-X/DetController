...
public class BleMsg {
    ...
    public static final int MSG_OVER = 9;
    public static final int MSG_ERROR = 100;
    public static final int MSG_QUERY_PROID = 1;
    public static final int MSG_QUERY_BLAST = 4;
    public static final int MSG_QUERY_CONTROLER = 2;
    public static final int MSG_QUERY_DET = 3;
    ...
    public static final int MSG_RPT_ETEK_ERR = 5;
    public static final int MSG_RPT_ETEK_TEST = 6;
    public static final int MSG_RPT_ETEK_OK = 7;

    public static final int MSG_VERIF = 6;
