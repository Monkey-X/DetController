...
public class ReportDetailAdapter extends BaseQuickAdapter<DetonatorEntity, BaseViewHolder> {

    public ReportDetailAdapter(int layoutResId, @Nullable List<DetonatorEntity> data) {
