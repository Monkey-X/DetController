...
public class DetReportAdapter extends SommerBaseAdapter<DetReportAdapter.ViewHolder> {


    public DetReportAdapter(Context mcontext) {
        super(mcontext);
    ...
    public DetReportAdapter(Context mcontext, List list) {
        super(mcontext);
        mList = list;
        this.mContext = mcontext;
    ...
    @Override
    public DetReportAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//        holder=new ViewHolder(view);
        ...
        return new DetReportAdapter.ViewHolder(getInflater().inflate(R.layout.item_det_report, parent, false));
    }
