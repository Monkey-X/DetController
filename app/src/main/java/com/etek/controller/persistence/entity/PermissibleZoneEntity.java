...
@Entity
public class PermissibleZoneEntity extends BaseEntity{
    ...
    public PermissibleZoneEntity() {
    }

    public PermissibleZoneEntity(int radius, double longitude, double latitude) {
        this.radius = radius;
        this.longitude = longitude;
        this.latitude = latitude;
    }

    public PermissibleZoneEntity(int radius, String name, double longitude, double latitude, Date startTime, Date stopTime) {
        this.radius = radius;
        this.name = name;
        this.longitude = longitude;
        this.latitude = latitude;
